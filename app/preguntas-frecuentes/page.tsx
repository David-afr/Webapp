            ...
            <div className="flex items-center w-full justify-center">
                <div className="bg-background py-initSectionY px-iniSectionX w-full sm:w-[70%]">
                    ...
                    <div className="mt-12  text-justify text-black text-lg sm:text-xl">
                        ...
                        <br/>
                        <p><strong className="font-bold">Compra en línea:</strong> Accede a nuestro MarketPlace y realiza tu compra en <a className="underline text-blue-500" href="market.miplante.com">www.miplante.com.</a></p>
                        <p><strong className="font-bold">Puntos de venta físicos:</strong> Visita los establecimientos de nuestros <a className="underline text-blue-500">aliados comerciales</a> y recibe asesoría personalizada.</p>
